...
const App = () => {
  ...
  const opacityChanger = new Animated.Value(0);
    ...
    <View style={styles.container}>
      <View style={styles.inputContainer}>
        ...
        <TextInput
          ...
          value={cep}
          ref={inputField}
          placeholder="Ex: 11015000"
        />
      </View>
      <View style={styles.btnContainer}>
        <TouchableOpacity
          style={[styles.btnField, {backgroundColor: 'green'}]}
          onPress={requestCep}>
          <Text style={styles.btnText}>Buscar</Text>
        </TouchableOpacity>
        <TouchableOpacity
          style={[styles.btnField, {backgroundColor: 'red'}]}
          onPress={clearAll}>
      ...
      {showInfo && (
        <Animated.View style={[styles.cepContainer, {opacity: opacityChanger}]}>
